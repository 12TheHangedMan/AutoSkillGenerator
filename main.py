...
from utility import *
import time
from skill_builder import load_modifier_space, load_skeleton_constraints, generate_skill, load_skill_from_dict
...
def main():
    ...
    test_unit_skill = generate_skill(modifier_space, skeleton_constraints)

    dummy_skill_data = load_json("dummy_skill.json")
    dummy_skill = load_skill_from_dict(dummy_skill_data)
